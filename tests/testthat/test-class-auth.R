...
testthat::test_that("Method files is working", {
  ...
  testthat::expect_error(auth$files(project = 1))
  testthat::expect_error(auth$files(project = TRUE))
  testthat::expect_error(auth$files(project = c("test")))
  testthat::expect_error(auth$files(project = list("test")))
  testthat::expect_error(auth$files(project = NULL))

  # Test project parameter
  testthat::expect_error(auth$files(parent = 1))
  testthat::expect_error(auth$files(parent = TRUE))
  testthat::expect_error(auth$files(parent = c("test")))
  testthat::expect_error(auth$files(parent = list("test")))
  testthat::expect_error(auth$files(parent = NULL))

  # Test both project and parent directory are not defined
  # nolint start
  ...
  testthat::expect_error(auth$files(project = project_obj, name = c("test")))
  testthat::expect_error(auth$files(project = project_obj, name = list("test")))
  testthat::expect_error(auth$files(project = project_obj, name = NULL))

  # Test metadata parameter
  testthat::expect_error(auth$files(project = project_obj, metadata = 1))
  testthat::expect_error(auth$files(project = project_obj, metadata = TRUE))
  # nolint start
  testthat::expect_error(auth$files(project = project_obj, metadata = c("test")))
  # nolint end
  testthat::expect_error(auth$files(project = project_obj, metadata = "test"))
  testthat::expect_error(auth$files(project = project_obj, metadata = NULL))

  # Test origin parameter
  testthat::expect_error(auth$files(project = project_obj, origin = 1))
  testthat::expect_error(auth$files(project = project_obj, origin = TRUE))
  testthat::expect_error(auth$files(project = project_obj, origin = c("test")))
  testthat::expect_error(auth$files(project = project_obj, origin = "test"))
  testthat::expect_error(auth$files(project = project_obj, origin = NULL))

  # Test tag parameter
  testthat::expect_error(auth$files(project = project_obj, tag = 1))
  testthat::expect_error(auth$files(project = project_obj, tag = TRUE))
  testthat::expect_error(auth$files(project = project_obj, tag = list("test")))
  testthat::expect_error(auth$files(project = project_obj, tag = "test"))
