test_that("Project member initialization works", {
  ...
  # Convert Permission env to a list and keep only those elements that are logical
...
test_that("Project print method works", {
  member_obj_file <- testthat::test_path("test_data", "ginny_weasley_member_object.RDS")
