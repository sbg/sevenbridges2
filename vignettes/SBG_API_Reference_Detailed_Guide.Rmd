...
Keep in mind that you can assign the output of the previous call to a variable, 
which will be an R6 environment:
```{r}
...
on both the tasks and Cruncher analysis, call:
...
To retrieve information about a selected invoice, including the costs for 
analysis and storage, and the invoice period, you can use the invoice method 
...
Same applies for invoices, if something changes, you can refresh your Invoice 
object by reloading it with:
