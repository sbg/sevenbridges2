...
(**default** and **aws-us-rfranklin**), we can achieve this in the following 
way:
...
tagged_projects <- a$projects$query(tags = list("test_1"))
```
...
```{r}
a$projects$get(id = "RFranklin/api-testing")
```
...
# Search by ID
star_app <- a$apps$get(
  id = "admin/sbg-public-data/rna-seq-alignment-star-2-7-10a/2"
)
```
...
p <- a$projects$get(id = "RFranklin/api-testing")
...
`admin/sbg-public-data/rna-seq-alignment-star-star-2-7-10a/2` into your project, 
...
- The inputs for your workflow. In this case, the CWL app accepts 
four parameters: number, min, max, and seed.
