---
title: "Projects and Tasks execution"
date: "`r Sys.Date()`"
output:
...
vignette: >
  ...
  %\VignetteIndexEntry{Projects and Tasks execution}
...
If app's `raw` field is empty, just call `reload()`, to fetch app's raw CWL.
...
...
```
Similarly, there is another utility operation on the `App` object to list 
expected outputs of the app/task. This information can be received by calling 
the `output_matrix()` method:
