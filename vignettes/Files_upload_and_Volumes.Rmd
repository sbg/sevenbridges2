...
Users with ADMIN privileges on divisions or enterprises can add whole teams and
divisions as members of a specified volume. 

Users with ADMIN privileges on some Division can add teams from this division
to a volume created in the same division:
