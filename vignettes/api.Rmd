...
returned. 
The output is a `VolumeFiles` collection (work in progress), that contains the 
...
aws_iam_user_volume$list_files(limit = 20)

# List all files specific directory on the bucket
aws_iam_user_volume$list_files(parent = "dir_name")

# Get next group of results by setting the continuation token
aws_iam_user_volume$list_files(
  limit = 20,
