...
content_collection <- aws_iam_user_volume$list_files(limit = 20)
...
content_collection <- aws_iam_user_volume$list_files(
  limit = 20,
...
calling list_files() directly on the VolumePrefix object.
...
of desired file received from response when returning list of volume files with `list_files()`.
