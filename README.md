...
devtools::install_github("sbg/sevenbridges-r2@develop")
```
...
Please file bug reports/feature requests on the [issue page](https://github.com/sbg/sevenbridges-r2/issues), or create pull requests [here](https://github.com/sbg/sevenbridges-r2/pulls).
